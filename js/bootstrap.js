 ...
 */ if ("undefined" == typeof jQuery) throw Error("Bootstrap's JavaScript requires jQuery");
 (function (t) {
    ...
    if ((e[0] < 2 && e[1] < 9) || (1 == e[0] && 9 == e[1] && e[2] < 1)) throw Error("Bootstrap's JavaScript requires jQuery version 1.9.1 or higher");
})(jQuery),
    (function (t) {
        "use strict";
        (t.fn.emulateTransitionEnd = function (e) {
            ...
            t(function () {
                (t.support.transition = (function t() {
                    ...
                    for (var o in i) if (void 0 !== e.style[o]) return { end: i[o] };
                    return !1;
                })()),
    ...
    (function (t) {
        ...
        var o = t.fn.alert;
        (t.fn.alert = function e(o) {
            return this.each(function () {
                var e = t(this),
                    s = e.data("bs.alert");
                s || e.data("bs.alert", (s = new i(this))), "string" == typeof o && s[o].call(e);
            });
        }),
    ...
    (function (t) {
        ...
        function e(e) {
            return this.each(function () {
                var o = t(this),
                    s = o.data("bs.button");
                s || o.data("bs.button", (s = new i(this, "object" == typeof e && e))), "toggle" == e ? s.toggle() : e && s.setState(e);
            });
        }
        var i = function (e, o) {
                ...
                if ((this.$element.trigger(d), !d.isDefaultPrevented())) {
                    ...
                    return (
                        t.support.transition && this.$element.hasClass("slide")
                            ...
                            : (s.removeClass("active"), n.addClass("active"), (this.sliding = !1), this.$element.trigger(c)),
                        a && this.cycle(),
                        this
                    );
                }
    ...
    (function (t) {
                ...
                t(s).each(function () {
                    ...
                    s.hasClass("open") &&
                        ((i && "click" == i.type && /input|textarea/i.test(i.target.tagName) && t.contains(s[0], i.target)) ||
                            (s.trigger((i = t.Event("hide.bs.dropdown", n))), i.isDefaultPrevented() || (o.attr("aria-expanded", "false"), s.removeClass("open").trigger("hidden.bs.dropdown", n))));
                }));
        }
        ...
        var a = t.fn.dropdown;
        (t.fn.dropdown = function e(i) {
            return this.each(function () {
                var e = t(this),
                    o = e.data("bs.dropdown");
                o || e.data("bs.dropdown", (o = new n(this))), "string" == typeof i && o[i].call(e);
            });
        }),
            ...
            t(document)
                ...
                .on("click.bs.dropdown.data-api", s, n.prototype.toggle)
                .on("keydown.bs.dropdown.data-api", s, n.prototype.keydown)
    ...
    (function (t) {
        ...
        (e.VERSION = "3.3.5"),
            ...
            (e.prototype.applyPlacement = function (e, i) {
                ...
                o.offset(e), this.replaceArrow(c, o[0][p ? "offsetWidth" : "offsetHeight"], p);
            }),
            ...
            (e.prototype.hide = function (i) {
                ...
                return (
                    ...
                    a.isDefaultPrevented() ? void 0 : (n.removeClass("in"), t.support.transition && n.hasClass("fade") ? n.one("bsTransitionEnd", o).emulateTransitionEnd(e.TRANSITION_DURATION) : o(), (this.hoverState = null), this)
                );
            }),
        ...
        (t.fn.tooltip = function i(o) {
            return this.each(function () {
                var i = t(this),
                    s = i.data("bs.tooltip");
                (s || !/destroy|hide/.test(o)) && (s || i.data("bs.tooltip", (s = new e(this, "object" == typeof o && o))), "string" == typeof o && s[o]());
            });
        }),
    ...
    (function (t) {
        ...
        var i = t.fn.popover;
        (t.fn.popover = function i(o) {
            return this.each(function () {
                var i = t(this),
                    s = i.data("bs.popover");
                (s || !/destroy|hide/.test(o)) && (s || i.data("bs.popover", (s = new e(this, "object" == typeof o && o))), "string" == typeof o && s[o]());
            });
        }),
    ...
    (function (t) {
        ...
        function i(i) {
            return this.each(function () {
                ...
                s || o.data("bs.scrollspy", (s = new e(this, "object" == typeof i && i))), "string" == typeof i && s[i]();
            });
        }
        (e.VERSION = "3.3.5"),
            ...
            (e.prototype.activate = function (e) {
                ...
                var i = t(this.selector + '[data-target="' + e + '"],' + this.selector + '[href="' + e + '"]')
                    .parents("li")
                    .addClass("active");
    ...
    (function (t) {
        ...
        function e(e) {
            return this.each(function () {
                var o = t(this),
                    s = o.data("bs.affix");
                s || o.data("bs.affix", (s = new i(this, "object" == typeof e && e))), "string" == typeof e && s[e]();
            });
        }
        var i = function (e, o) {
