        ...
        if (a.parent().hasClass("nav-special")) {
            if ((e.stopPropagation(), $(this).hasClass("selected-nav")))
                ...
                var o,
                    l,
                    s,
                    n = t.attr("class").replace("navbar", "").replace("row", ""),
                    c = a.parent().attr("class").replace("navbar-collapse", "").replace("collapse", "");
                ($(".content-tint").length = -1),
                    $("body").append('<div class="content-tint"></div>'),
                    i.insertBefore(".page-container").wrap('<div class="blocsapp-special-menu ' + n + '"><blocsnav class="' + c + '">'),
                    $("blocsnav").prepend('<a class="close-special-menu animated fadeIn" style="animation-delay:0.5s;"><div class="close-icon"></div></a>'),
                    (o = "fadeInRight"),
                    (l = 0),
                    (s = 60),
                    $(".blocsapp-special-menu blocsnav").hasClass("fullscreen-nav") ? ((o = "fadeIn"), (s = 100)) : $(".blocsapp-special-menu").hasClass("nav-invert") && (o = "fadeInLeft"),
                    $(".blocsapp-special-menu blocsnav li").each(function () {
                        $(this).parent().hasClass("dropdown-menu")
                            ? $(this).addClass("animated fadeIn")
                            : ((l += s),
                              $(this)
                                  .attr("style", "animation-delay:" + l + "ms")
                                  .addClass("animated " + o));
                    }),
                    setTimeout(function () {
...
function inViewCheck() {
    $($(".hideMe").get().reverse()).each(function (e) {
        ...
        if ((t.height() > $(window).height() && (a = t.offset().top), a < i)) {
    ...
    window.targetLightbox,
        $(document)
            .on("click", "[data-lightbox]", function (e) {
                e.preventDefault();
                var t = (targetLightbox = $(this)).attr("data-lightbox"),
        ...
        $(document).on("click", ".next-lightbox, .prev-lightbox", function (e) {
            ...
            targetLightbox.attr("data-gallery-id") && ((a = $('a[data-gallery-id="' + (t = targetLightbox.attr("data-gallery-id")) + '"]').index(targetLightbox)), (i = $('a[data-gallery-id="' + t + '"]').eq(a + 1))),
                $(this).hasClass("prev-lightbox") && ((i = $('a[data-gallery-id="' + t + '"]').eq(a - 1)), "no-gallery-set" == t && (i = $("a[data-lightbox]").eq(a - 1)));
            var o = i.attr("data-lightbox");
            if (".mp4" == o.substring(o.length - 4)) {
                var l = "";
                1 == i.attr("data-autoplay") && (l = "autoplay"),
            ...
            (targetLightbox = i),
                ...
                "no-gallery-set" == t
                    ? ($("a[data-lightbox]").index(i) != $("a[data-lightbox]").length - 1 && $(".next-lightbox").show(), $("a[data-lightbox]").index(i) > 0 && $(".prev-lightbox").show())
                    : ($('a[data-gallery-id="' + t + '"]').index(i) != $('a[data-gallery-id="' + t + '"]').length - 1 && $(".next-lightbox").show(), $('a[data-gallery-id="' + t + '"]').index(i) > 0 && $(".prev-lightbox").show());
        });
}
