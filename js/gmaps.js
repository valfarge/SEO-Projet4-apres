"use strict";
!(function (t, o) {
    "object" == typeof exports ? (module.exports = o()) : "function" == typeof define && define.amd ? define(["jquery", "googlemaps!"], o) : (t.GMaps = o());
})(this, function () {
    /*!
     * GMaps.js v0.4.25
     ...
     */ var t,
        ...
        a = function (t, o) {
            ...
            else for (n = 0; n < i; n++) (callback_params = r).splice(0, 0, t[n]), s.push(o.apply(this, callback_params));
            return s;
        },
        l = function (t) {
            var o,
        ...
        c = function (t, o) {
            var n;
            for (n = 0; n < t.length; n++) t[n] instanceof google.maps.LatLng || (t[n].length > 0 && "object" == typeof t[n][0] ? (t[n] = c(t[n], o)) : (t[n] = p(t[n], o)));
            return t;
        },
        h = function (t, o) {
            var n,
                r = t.replace(".", "");
            return "jQuery" in this && o ? $("." + r, o)[0] : document.getElementsByClassName(r)[0];
        },
        u = function (t, o) {
            var n,
                t = t.replace("#", "");
            return "jQuery" in window && o ? $("#" + t, o)[0] : document.getElementById(t);
        },
        d = function (t) {
            var o = 0,
                n = 0;
            ...
            (s = function (t) {
                ...
                var o,
                    ...
                    T = {
                        panControl: b,
                        zoomControl: v,
                        zoomControlOptions: { style: google.maps.ZoomControlStyle[w], position: google.maps.ControlPosition[L] },
                        mapTypeControl: x,
                        scaleControl: M,
                        streetViewControl: C,
                        overviewMapControl: O,
                    };
                if (("string" == typeof t.el || "string" == typeof t.div ? (f.indexOf("#") > -1 ? (this.el = u(f, t.context)) : (this.el = h.apply(this, [f, t.context]))) : (this.el = f), void 0 === this.el || null === this.el))
                ...
                for (
                    o = 0,
                        ...
                        this.el.style.width = t.width || this.el.scrollWidth || this.el.offsetWidth,
                        this.el.style.height = t.height || this.el.scrollHeight || this.el.offsetHeight,
                        google.maps.visualRefresh = t.enableNewStyle;
                    o < c.length;
                    o++
                )
                    delete t[c[o]];
                for (!0 != t.disableDefaultUI && (_ = i(_, T)), P = i(_, t), o = 0; o < l.length; o++) delete P[l[o]];
                for (o = 0; o < p.length; o++) delete P[p[o]];
                (this.map = new google.maps.Map(this.el, P)), m && (this.markerClusterer = m.apply(this, [this.map]));
                var z = function (t, o) {
                    var n = "",
                    ...
                    for (var s in r)
                        if (r.hasOwnProperty(s)) {
                            var i = r[s];
                            n += '<li><a id="' + t + "_" + s + '" href="#">' + i.title + "</a></li>";
                        }
                    if (u("gmaps_context_menu")) {
                        ...
                        for (s = 0; s < c; s++) {
                            var h = p[s],
                                f = function (n) {
                                    n.preventDefault(), r[this.id.replace(t + "_", "")].action.apply(a, [o]), a.hideContextMenu();
                                };
                    ...
                    (this.setContextMenu = function (t) {
                        ...
                        for (o in t.options)
                            if (t.options.hasOwnProperty(o)) {
                                var s = t.options[o];
                                window.context_menu[a.el.id][t.control][s.name] = { title: s.title, action: s.action };
                            }
                ...
                var S = function (o, n) {
                    google.maps.event.addListener(o, n, function (o) {
                        void 0 == o && (o = this), t[n].apply(this, [o]), a.hideContextMenu();
                    });
                };
                ...
                google.maps.event.addListener(this.map, "rightclick", function (o) {
                    t.rightclick && t.rightclick.apply(this, [o]), void 0 != window.context_menu[a.el.id].map && a.buildContextMenu("map", o);
                }),
                    ...
                    (this.fitZoom = function () {
                        ...
                        for (t = 0; t < n; t++) "boolean" == typeof this.markers[t].visible && this.markers[t].visible && o.push(this.markers[t].getPosition());
                ...
                var I,
                    j = [];
                for (I in this.map) "function" != typeof this.map[I] || this[I] || j.push(I);
    ...
    return (
        (f.prototype.createControl = function (t) {
            ...
            !0 !== t.disableDefaultStyles && ((o.style.fontFamily = "Roboto, Arial, sans-serif"), (o.style.fontSize = "11px"), (o.style.boxShadow = "rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px")),
            t.style))
                o.style[n] = t.style[n];
            for (var r in (t.id && (o.id = t.id),
            t.title && (o.title = t.title),
            t.classes && (o.className = t.classes),
            t.content && ("string" == typeof t.content ? (o.innerHTML = t.content) : t.content instanceof HTMLElement && o.appendChild(t.content)),
            t.position && (o.position = google.maps.ControlPosition[t.position.toUpperCase()]),
            t.events))
                !(function (o, n) {
        ...
        (f.prototype.removeControl = function (t) {
            var o,
                n = null;
            for (o = 0; o < this.controls.length; o++) this.controls[o] == t && ((n = this.controls[o].position), this.controls.splice(o, 1));
            if (n)
                ...
                !(function (o, n, r) {
                    t[r] &&
                        google.maps.event.addListener(n, r, function (n) {
                            n.pixel || (n.pixel = o.getProjection().fromLatLngToPoint(n.latLng)), t[r].apply(this, [n]);
                        });
                })(this.map, l, u[c]);
            return (
                google.maps.event.addListener(l, "click", function () {
                    (this.details = n), t.click && t.click.apply(this, [this]), l.infoWindow && (o.hideInfoWindows(), l.infoWindow.open(o.map, l));
                }),
                google.maps.event.addListener(l, "rightclick", function (n) {
                    (n.marker = this), t.rightclick && t.rightclick.apply(this, [n]), void 0 != window.context_menu[o.el.id].marker && o.buildContextMenu("marker", n);
                }),
                l.fences &&
        ...
        (f.prototype.addMarker = function (t) {
            ...
            else if ((t.hasOwnProperty("lat") && t.hasOwnProperty("lng")) || t.position) o = this.createMarker(t);
            else throw "No latitude or longitude defined.";
            return o.setMap(this.map), this.markerClusterer && this.markerClusterer.addMarker(o), this.markers.push(o), f.fire("marker_added", o, this), o;
        }),
        ...
        (f.prototype.hideInfoWindows = function () {
            for (var t, o = 0; (t = this.markers[o]); o++) t.infoWindow && t.infoWindow.close();
        }),
        (f.prototype.removeMarker = function (t) {
            for (var o = 0; o < this.markers.length; o++)
                if (this.markers[o] === t) {
                    this.markers[o].setMap(null), this.markers.splice(o, 1), this.markerClusterer && this.markerClusterer.removeMarker(t), f.fire("marker_removed", t, this);
                    break;
                }
            return t;
        }),
        (f.prototype.removeMarkers = function (t) {
            ...
            if (void 0 === t) {
                ...
                this.markerClusterer && this.markerClusterer.clearMarkers && this.markerClusterer.clearMarkers(), (this.markers = o);
            } else {
                for (var n = 0; n < t.length; n++) {
                    var s = this.markers.indexOf(t[n]);
                    if (s > -1) {
                        var r = this.markers[s];
                        r.setMap(null), this.markerClusterer && this.markerClusterer.removeMarker(r), f.fire("marker_removed", r, this);
                    }
                }
                for (var n = 0; n < this.markers.length; n++) {
                    var r = this.markers[n];
        ...
        (f.prototype.drawOverlay = function (t) {
            ...
            return (
                ...
                (o.onAdd = function () {
                    ...
                    (s.style.borderStyle = "none"), (s.style.borderWidth = "0px"), (s.style.position = "absolute"), (s.style.zIndex = 100), (s.innerHTML = t.content), (o.el = s), t.layer || (t.layer = "overlayLayer");
                    var i = this.getPanes(),
                        a = i[t.layer],
                ...
                (o.draw = function () {
                    var r = this.getProjection().fromLatLngToDivPixel(new google.maps.LatLng(t.lat, t.lng));
                ...
                (o.onRemove = function () {
                    var n = o.el;
                    t.remove ? t.remove.apply(this, [n]) : (o.el.parentNode.removeChild(o.el), (o.el = null));
                }),
        ...
        (f.prototype.drawPolyline = function (t) {
            ...
            if (n.length) {
                if (void 0 === n[0][0]) o = n;
                else for (var r, s = 0; (r = n[s]); s++) o.push(new google.maps.LatLng(r[0], r[1]));
            }
            var i = { map: this.map, path: o, strokeColor: t.strokeColor, strokeOpacity: t.strokeOpacity, strokeWeight: t.strokeWeight, geodesic: t.geodesic, clickable: !0, editable: !1, visible: !0 };
            t.hasOwnProperty("clickable") && (i.clickable = t.clickable), t.hasOwnProperty("editable") && (i.editable = t.editable), t.hasOwnProperty("icons") && (i.icons = t.icons), t.hasOwnProperty("zIndex") && (i.zIndex = t.zIndex);
            for (var a = new google.maps.Polyline(i), l = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], p = 0; p < l.length; p++)
                !(function (o, n) {
                    t[n] &&
                        google.maps.event.addListener(o, n, function (o) {
                            t[n].apply(this, [o]);
        ...
        (f.prototype.removePolyline = function (t) {
            for (var o = 0; o < this.polylines.length; o++)
                if (this.polylines[o] === t) {
                    this.polylines[o].setMap(null), this.polylines.splice(o, 1), f.fire("polyline_removed", t, this);
                    break;
                }
        }),
        ...
        (f.prototype.drawCircle = function (t) {
            delete (t = i({ map: this.map, center: new google.maps.LatLng(t.lat, t.lng) }, t)).lat, delete t.lng;
            for (var o = new google.maps.Circle(t), n = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], r = 0; r < n.length; r++)
                !(function (o, n) {
                    t[n] &&
                        google.maps.event.addListener(o, n, function (o) {
                            t[n].apply(this, [o]);
        ...
        (f.prototype.drawRectangle = function (t) {
            t = i({ map: this.map }, t);
            var o = new google.maps.LatLngBounds(new google.maps.LatLng(t.bounds[0][0], t.bounds[0][1]), new google.maps.LatLng(t.bounds[1][0], t.bounds[1][1]));
            t.bounds = o;
            for (var n = new google.maps.Rectangle(t), r = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], s = 0; s < r.length; s++)
                !(function (o, n) {
                    t[n] &&
                        google.maps.event.addListener(o, n, function (o) {
                            t[n].apply(this, [o]);
        ...
        (f.prototype.drawPolygon = function (t) {
            var o = !1;
            t.hasOwnProperty("useGeoJSON") && (o = t.useGeoJSON), delete t.useGeoJSON, (t = i({ map: this.map }, t)), !1 == o && (t.paths = [t.paths.slice(0)]), t.paths.length > 0 && t.paths[0].length > 0 && (t.paths = l(a(t.paths, c, o)));
            for (var n = new google.maps.Polygon(t), r = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], s = 0; s < r.length; s++)
                !(function (o, n) {
                    t[n] &&
                        google.maps.event.addListener(o, n, function (o) {
                            t[n].apply(this, [o]);
        ...
        (f.prototype.removePolygon = function (t) {
            for (var o = 0; o < this.polygons.length; o++)
                if (this.polygons[o] === t) {
                    this.polygons[o].setMap(null), this.polygons.splice(o, 1), f.fire("polygon_removed", t, this);
                    break;
                }
        }),
        ...
        (f.prototype.addLayer = function (t, o) {
            switch (((o = o || {}), t)) {
                ...
                case "panoramio":
                    ...
                    break;
                case "places":
                    if (((this.singleLayers.places = n = new google.maps.places.PlacesService(this.map)), o.search || o.nearbySearch || o.radarSearch)) {
                        var n,
                            r = { bounds: o.bounds || null, keyword: o.keyword || null, location: o.location || null, name: o.name || null, radius: o.radius || null, rankBy: o.rankBy || null, types: o.types || null };
                        o.radarSearch && n.radarSearch(r, o.radarSearch), o.search && n.search(r, o.search), o.nearbySearch && n.nearbySearch(r, o.nearbySearch);
                    }
                    if (o.textSearch) {
                        var s = { bounds: o.bounds || null, location: o.location || null, query: o.query || null, radius: o.radius || null };
                        n.textSearch(s, o.textSearch);
                    }
            }
            if (void 0 !== n) return "function" == typeof n.setOptions && n.setOptions(o), "function" == typeof n.setMap && n.setMap(this.map), n;
        }),
        ...
        (f.prototype.getRoutes = function (n) {
            ...
            var r = i({ avoidHighways: !1, avoidTolls: !1, optimizeWaypoints: !1, waypoints: [] }, n);
            (r.origin = /string/.test(typeof n.origin) ? n.origin : new google.maps.LatLng(n.origin[0], n.origin[1])),
                (r.destination = /string/.test(typeof n.destination) ? n.destination : new google.maps.LatLng(n.destination[0], n.destination[1])),
                (r.travelMode = t),
                (r.unitSystem = o),
                delete r.callback,
                delete r.error;
            ...
            new google.maps.DirectionsService().route(r, function (t, o) {
                if (o === google.maps.DirectionsStatus.OK) {
                    for (var r in t.routes) t.routes.hasOwnProperty(r) && s.push(t.routes[r]);
        ...
        (f.prototype.getElevations = function (t) {
            (t = i({ locations: [], path: !1, samples: 256 }, t)).locations.length > 0 && t.locations[0].length > 0 && (t.locations = l(a([t.locations], c, !1)));
            var o = t.callback;
            delete t.callback;
        ...
        (f.prototype.drawRoute = function (t) {
            ...
            this.getRoutes({
                ...
                callback: function (n) {
                    if (n.length > 0) {
                        var r = { path: n[n.length - 1].overview_path, strokeColor: t.strokeColor, strokeOpacity: t.strokeOpacity, strokeWeight: t.strokeWeight };
                        t.hasOwnProperty("icons") && (r.icons = t.icons), o.drawPolyline(r), t.callback && t.callback(n[n.length - 1]);
                    }
                },
            });
        }),
        (f.prototype.travelRoute = function (t) {
            if (t.origin && t.destination)
                this.getRoutes({
                    ...
                    error: t.error,
                    callback: function (o) {
                        if ((o.length > 0 && t.start && t.start(o[o.length - 1]), o.length > 0 && t.step)) {
                            var n = o[o.length - 1];
                            if (n.legs.length > 0) for (var r, s = n.legs[0].steps, i = 0; (r = s[i]); i++) (r.step_number = i), t.step(r, n.legs[0].steps.length - 1);
                        }
                        o.length > 0 && t.end && t.end(o[o.length - 1]);
                    },
                });
            else if (t.route && t.route.legs.length > 0) for (var o, n = t.route.legs[0].steps, r = 0; (o = n[r]); r++) (o.step_number = r), t.step(o);
        }),
        (f.prototype.drawSteppedRoute = function (t) {
            ...
            if (t.origin && t.destination)
                        ...
                        if ((n.length > 0 && t.start && t.start(n[n.length - 1]), n.length > 0 && t.step)) {
                            ...
                            if (r.legs.length > 0)
                                for (var s, i = r.legs[0].steps, a = 0; (s = i[a]); a++) {
                                    s.step_number = a;
                                    var l = { path: s.path, strokeColor: t.strokeColor, strokeOpacity: t.strokeOpacity, strokeWeight: t.strokeWeight };
                                    t.hasOwnProperty("icons") && (l.icons = t.icons), o.drawPolyline(l), t.step(s, r.legs[0].steps.length - 1);
                                }
                        }
                ...
                for (var n, r = t.route.legs[0].steps, s = 0; (n = r[s]); s++) {
                    n.step_number = s;
                    var i = { path: n.path, strokeColor: t.strokeColor, strokeOpacity: t.strokeOpacity, strokeWeight: t.strokeWeight };
                    t.hasOwnProperty("icons") && (i.icons = t.icons), o.drawPolyline(i), t.step(n);
                }
        }),
        (f.Route = function (t) {
            ...
            var o = { path: new google.maps.MVCArray(), strokeColor: t.strokeColor, strokeOpacity: t.strokeOpacity, strokeWeight: t.strokeWeight };
            t.hasOwnProperty("icons") && (o.icons = t.icons), (this.polyline = this.map.drawPolyline(o).getPath());
        }),
        ...
        (f.prototype.toImage = function (t) {
            var t = t || {},
                o = {};
            if (((o.size = t.size || [this.el.clientWidth, this.el.clientHeight]), (o.lat = this.getCenter().lat()), (o.lng = this.getCenter().lng()), this.markers.length > 0)) {
                o.markers = [];
                for (var n = 0; n < this.markers.length; n++) o.markers.push({ lat: this.markers[n].getPosition().lat(), lng: this.markers[n].getPosition().lng() });
            }
            if (this.polylines.length > 0) {
                var r = this.polylines[0];
                (o.polyline = {}),
                    (o.polyline.path = google.maps.geometry.encoding.encodePath(r.getPath())),
        ...
        (f.staticMapURL = function (t) {
            ...
            var p = t.size;
            p ? (p.join && (p = p.join("x")), delete t.size) : (p = "630x300"), n.push("size=" + p), t.zoom || !1 === t.zoom || (t.zoom = 15);
            var c = !t.hasOwnProperty("sensor") || !!t.sensor;
            for (var h in (delete t.sensor, n.push("sensor=" + c), t)) t.hasOwnProperty(h) && n.push(h + "=" + t[h]);
            if (s)
                for (var u = 0; (o = s[u]); u++) {
                    for (var h in ((b = []),
                    o.size && "normal" !== o.size ? (b.push("size:" + o.size), delete o.size) : o.icon && (b.push("icon:" + encodeURI(o.icon)), delete o.icon),
                    o.color && (b.push("color:" + o.color.replace("#", "0x")), delete o.color),
                    o.label && (b.push("label:" + o.label[0].toUpperCase()), delete o.label),
                    ...
                    b.length || 0 === u ? (b.push(x), (b = b.join("|")), n.push("markers=" + encodeURI(b))) : ((b = n.pop() + encodeURI("|" + x)), n.push(b));
                }
            if (i)
                for (var u = 0; u < i.length; u++) {
                    var d = [];
                    i[u].featureType && d.push("feature:" + i[u].featureType.toLowerCase()), i[u].elementType && d.push("element:" + i[u].elementType.toLowerCase());
                    for (var f = 0; f < i[u].stylers.length; f++)
                        for (var m in i[u].stylers[f]) {
                            var g = i[u].stylers[f][m];
                            ("hue" == m || "color" == m) && (g = "0x" + g.substring(1)), d.push(m + ":" + g);
                        }
                    var y = d.join("|");
                    "" != y && n.push("style=" + y);
                }
            function v(t, o) {
                if ("#" === t[0] && ((t = t.replace("#", "0x")), o)) {
                    if (0 === (o = Math.min(1, Math.max((o = parseFloat(o)), 0)))) return "0x00000000";
                    1 === (o = (255 * o).toString(16)).length && (o += o), (t = t.slice(0, 8) + o);
                }
                return t;
            }
            if (a) {
                ...
                var L = o.path;
                if (L.join) for (var b, x, M, f = 0; (M = L[f]); f++) a.push(M.join(","));
                else a.push("enc:" + L);
        ...
        (f.prototype.addStyle = function (t) {
            var o = new google.maps.StyledMapType(t.styles, { name: t.styledMapName });
        ...
        (f.prototype.createPanorama = function (t) {
            return (t.hasOwnProperty("lat") && t.hasOwnProperty("lng")) || ((t.lat = this.getCenter().lat()), (t.lng = this.getCenter().lng())), (this.panorama = f.createPanorama(t)), this.map.setStreetView(this.panorama), this.panorama;
        }),
        (f.createPanorama = function (t) {
            ...
            for (var n = ["closeclick", "links_changed", "pano_changed", "position_changed", "pov_changed", "resize", "visible_changed"], r = i({ visible: !0 }, t), s = 0; s < n.length; s++) delete r[n[s]];
            for (var a = new google.maps.StreetViewPanorama(o, r), s = 0; s < n.length; s++)
                !(function (o, n) {
                    t[n] &&
                        google.maps.event.addListener(o, n, function () {
                            t[n].apply(this);
        ...
        (f.on = function (t, o, n) {
            if (-1 == f.custom_events.indexOf(t)) return o instanceof f && (o = o.map), google.maps.event.addListener(o, t, n);
            var r = { handler: n, eventName: t };
            return (o.registered_events[t] = o.registered_events[t] || []), o.registered_events[t].push(r), r;
        }),
        (f.off = function (t, o) {
            -1 == f.custom_events.indexOf(t) ? (o instanceof f && (o = o.map), google.maps.event.clearListeners(o, t)) : (o.registered_events[t] = []);
        }),
        (f.once = function (t, o, n) {
            if (-1 == f.custom_events.indexOf(t)) return o instanceof f && (o = o.map), google.maps.event.addListenerOnce(o, t, n);
        }),
        (f.fire = function (t, o, n) {
            if (-1 == f.custom_events.indexOf(t)) google.maps.event.trigger(o, t, Array.prototype.slice.apply(arguments).slice(2));
        ...
        "object" == typeof window.google &&
            ...
            (google.maps.Polygon.prototype.getBounds ||
                (google.maps.Polygon.prototype.getBounds = function (t) {
                    for (var o, n = new google.maps.LatLngBounds(), r = this.getPaths(), s = 0; s < r.getLength(); s++) {
                        o = r.getAt(s);
            ...
            google.maps.Polygon.prototype.containsLatLng ||
                (google.maps.Polygon.prototype.containsLatLng = function (t) {
                    ...
                    for (var n = !1, r = this.getPaths().getLength(), s = 0; s < r; s++)
                        for (var i = this.getPaths().getAt(s), a = i.getLength(), l = a - 1, p = 0; p < a; p++) {
                            var c = i.getAt(p),
                                h = i.getAt(l);
                            ((c.lng() < t.lng() && h.lng() >= t.lng()) || (h.lng() < t.lng() && c.lng() >= t.lng())) && c.lat() + ((t.lng() - c.lng()) / (h.lng() - c.lng())) * (h.lat() - c.lat()) < t.lat() && (n = !n), (l = p);
                        }
                    return n;
                }),
        ...
        Array.prototype.indexOf ||
            (Array.prototype.indexOf = function (t) {
                ...
                for (var s = r >= 0 ? r : Math.max(n - Math.abs(r), 0); s < n; s++) if (s in o && o[s] === t) return s;
                return -1;
            }),
        f
    );
