    ...
    var t = [],
        e = {
            ...
            methods: {
                    ...
                    return (
                        a(l).bind("submit", function (t) {
                            ...
                            n.trigger("submit.validation").trigger("validationLostFocus.validation"),
                                n.each(function (t, e) {
                                    var n = a(e).parents(".form-group, .checkbox").first();
                        ...
                        this.each(function () {
                            var e = a(this),
                                o = e.parents(".form-group, .checkbox").first(),
                                l = o.find(".help-block").first(),
                                d = e.parents("form").first(),
                                s = [];
                            if ((!l.length && r.options.autoAdd && r.options.autoAdd.helpBlocks && ((l = a('<div class="help-block" />')), o.append(l), t.push(l[0])), r.options.sniffHtml)) {
                                var c = "";
                                if (
                                        ...
                                        (c = a.unique(c.sort())).length
                                            ? (o.removeClass("success error").addClass("warning"),
                                              r.options.semanticallyStrict && 1 === c.length
                                                  ...
                                                  : l.html('<ul class="list-unstyled alert alert-warning" role="alert"><li>' + c.join("</li><li>") + "</li></ul>" + (r.options.prependExistingHelpBlock ? l.data("original-contents") : "")))
                ...
                destroy: function () {
                    return this.each(function () {
                        var e = a(this),
                            i = e.parents(".form-group, .checkbox").first(),
            ...
            builtInValidators: {
                ...
                validemail: { name: "Validemail", type: "regex", regex: "[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,10}", message: "Not a valid email address<!-- data-validator-validemail-message to override -->" },
